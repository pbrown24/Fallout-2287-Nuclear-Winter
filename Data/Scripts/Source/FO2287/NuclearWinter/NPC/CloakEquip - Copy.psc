Scriptname NuclearWinter:NPC:CloakEquip extends ActiveMagicEffect
{MGEF:NuclearWinter_CloakEquipEffect}
...
Function AddMask()
	If (NPC.HasKeyword(NuclearWinter_NPC_CloakKeyword) == False)
		NPC.AddItem(NuclearWinter_NPC_Raider_RandomGeneral,1,true)
		WriteLine(Log, "The NPC '"+NPC+"' added the gas mask '"+NuclearWinter_NPC_Raider_RandomGeneral+"'.")
		StartTimer(5, TimerID)
	EndIf
EndFunction
...
Group Properties
	...
	LeveledItem Property NuclearWinter_NPC_Raider_RandomGeneral Auto Const Mandatory
EndGroup
